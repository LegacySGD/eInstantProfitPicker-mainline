...
public class ProfitPickerCOMEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(ProfitPickerCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/ProfitPickerIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/ProfitPickerIW/InitOutcome.xml").getDocumentElement();
