	...
	<xsl:template match="/Paytable/PaytableData/ComponentsDataMapping">
		<html>
			<head>
				...
				<![CDATA[
				var visibleForm = "Force.Form100";
				var prevDivSection = [];
				function OnWindowLoad()
				{
					var pricePoints = [100,200,300,500,1000];
					var numDivisions = 31;
				...
				{
					document.getElementById("DivisionSelection100.Scenario.D" + prevDivSection[0]).setAttribute("hidden", "hidden");
				...
				{
					document.getElementById("DivisionSelection200.Scenario.D" + prevDivSection[1]).setAttribute("hidden", "hidden");
				...
				{
					document.getElementById("DivisionSelection300.Scenario.D" + prevDivSection[2]).setAttribute("hidden", "hidden");
				...
				{
					document.getElementById("DivisionSelection500.Scenario.D" + prevDivSection[3]).setAttribute("hidden", "hidden");
				...
				{
					document.getElementById("DivisionSelection1000.Scenario.D" + prevDivSection[4]).setAttribute("hidden", "hidden");
